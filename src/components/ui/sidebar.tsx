...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        "absolute inset-y-0 z-20 w-5 -translate-x-1/2 transition-all ease-linear bg-sidebar/10 hover:bg-sidebar/20",
        "after:absolute after:inset-y-2 after:left-1/2 after:w-[3px] after:-translate-x-1/2 after:rounded-sm after:bg-sidebar-border after:transition-transform hover:after:scale-x-110",
