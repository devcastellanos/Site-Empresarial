...
export function Convenio() {
  ...
  useEffect(() => {
    const fetchConvenios = async () => {
      try {
        const response = await fetch("https://apicursos.in.grupotarahumara.com.mx/Convenios");
  ...
  const handleDeleteConvenio = async (idConvenio: number) => {
    try {
      const response = await fetch("https://apicursos.in.grupotarahumara.com.mx/eliminarConvenio", {
        method: "DELETE",
  ...
  const handleAddConvenio = async () => {
    ...
    try {
      ...
      const response = await fetch("https://apicursos.in.grupotarahumara.com.mx/agregarConvenio", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
